 ...
 * B1 0		B2 0	B3 0	B4 0	B5 0	B6 0	B7 0	B8 0
 */
EXTERN_INLINE void unpack_argb_to_0r_g_b_vectors_sse2(__m128i* in_2_v8i_argb_vectors, __m128i* out_3_v16i_0r_g_b_vectors)
{
	CONST_M128I(mask_off_agb, 0x0000FF000000FF00LL, 0x0000FF000000FF00LL);
	CONST_M128I(mask_off_arb, 0x00FF000000FF0000LL, 0x00FF000000FF0000LL);
	CONST_M128I(mask_off_arg, 0xFF000000FF000000LL, 0xFF000000FF000000LL);
	...
	out_3_v16i_0r_g_b_vectors[0] = _mm_and_si128(in_2_v8i_argb_vectors[0], _M(mask_off_agb));	// PAND		2	2
	// 0 R1 	0 0		0 R2	0 0		0 R3 	0 0		0 R4 	0 0
	
	_M(scratch1) = _mm_and_si128(in_2_v8i_argb_vectors[1], _M(mask_off_agb));					// PAND		2	2
	// 0 R5 	0 0		0 R6	0 0		0 R7 	0 0		0 R8 	0 0
	
	out_3_v16i_0r_g_b_vectors[0] = _mm_packs_epi32(out_3_v16i_0r_g_b_vectors[0], _M(scratch1));//PACKSSDW	4 4 2 2
	// 0 R1 	0 R2	0 R3 	0 R4 	0 R5	0 R6	0 R7	0 R8
	
	
	
	out_3_v16i_0r_g_b_vectors[1] = _mm_and_si128(in_2_v8i_argb_vectors[0], _M(mask_off_arb));	// PAND		2	2
	// 0 0		G1 0	0 0		G2 0	0 0		G3 0	0 0		G4 0
	
	out_3_v16i_0r_g_b_vectors[1] = _mm_srli_epi32(out_3_v16i_0r_g_b_vectors[1], 16);			// PSRLD	2   2
	// G1 0 	0 0		G2 0	0 0		G3 0	0 0		G4 0 	0 0
	...
	out_3_v16i_0r_g_b_vectors[1] = _mm_packs_epi32(out_3_v16i_0r_g_b_vectors[1], _M(scratch1));//PACKSSDW	4 4 2 2
	// G1 0		G2 0	G3 0	G4 0	G5 0	G6 0	G7 0	G8 0
	
	
	
	out_3_v16i_0r_g_b_vectors[2] = _mm_and_si128(in_2_v8i_argb_vectors[0], _M(mask_off_arg));	// PAND		2	2
	// 0 0		0 B1	0 0		0 B2	0 0		0 B3	0 0		0 B4
	
	out_3_v16i_0r_g_b_vectors[2] = _mm_srli_epi32(out_3_v16i_0r_g_b_vectors[2], 24);			// PSRLD	2   2
	// B1 0 	0 0		B2 0	0 0		B3 0	0 0		B4 0 	0 0
	...
	out_3_v16i_0r_g_b_vectors[2] = _mm_packs_epi32(out_3_v16i_0r_g_b_vectors[2], _M(scratch1));//PACKSSDW	4 4 2 2
	// B1 0		B2 0	B3 0	B4 0	B5 0	B6 0	B7 0	B8 0
};
 ...
 * B1 0		B2 0	B3 0	B4 0	B5 0	B6 0	B7 0	B8 0
 */
EXTERN_INLINE void unpack_argb_to_0r_g_b_vectors_sse2_ssse3(__m128i* in_2_v8i_argb_vectors, __m128i* out_3_v16i_0r_g_b_vectors)
{
	CONST_M128I(shuf_r1, 0x0DFF09FF05FF01FFLL, 0xFFFFFFFFFFFFFFFFLL);
	CONST_M128I(shuf_r2, 0xFFFFFFFFFFFFFFFFLL, 0x0DFF09FF05FF01FFLL);
	CONST_M128I(shuf_g1, 0xFF0EFF0AFF06FF02LL, 0xFFFFFFFFFFFFFFFFLL);
	CONST_M128I(shuf_g2, 0xFFFFFFFFFFFFFFFFLL, 0xFF0EFF0AFF06FF02LL);
	CONST_M128I(shuf_b1, 0xFF0FFF0BFF07FF03LL, 0xFFFFFFFFFFFFFFFFLL);
	CONST_M128I(shuf_b2, 0xFFFFFFFFFFFFFFFFLL, 0xFF0FFF0BFF07FF03LL);
	...
	_M(scratch1) = _mm_shuffle_epi8(in_2_v8i_argb_vectors[0], _M(shuf_r1));					// PSHUFB	1 1 3 0 1 2
	// 0 R1		0 R2	0 R3	0 R4	0 0		0 0		0 0		0 0
	
	out_3_v16i_0r_g_b_vectors[0] = _mm_shuffle_epi8(in_2_v8i_argb_vectors[1], _M(shuf_r2));	// PSHUFB	1 1 3 0 1 2
	// 0 0		0 0		0 0		0 0		0 R5	0 R6	0 R7	0 R8
	
	out_3_v16i_0r_g_b_vectors[0] = _mm_or_si128(out_3_v16i_0r_g_b_vectors[0], _M(scratch1));	// POR	2   2
	// 0 R1		0 R2	0 R3	0 R4	0 R5	0 R6	0 R7	0 R8
	...
	out_3_v16i_0r_g_b_vectors[1] = _mm_shuffle_epi8(in_2_v8i_argb_vectors[1], _M(shuf_g2));	// PSHUFB	1 1 3 0 1 2
	// 0 0		0 0		0 0		0 0		G5 0	G6 0	G7 0	G8 0
	
	out_3_v16i_0r_g_b_vectors[1] = _mm_or_si128(out_3_v16i_0r_g_b_vectors[1], _M(scratch1));	// POR	2   2
	// G1  0	G2 0	G3  0	G4  0	G5  0	G6  0	G7  0	G8  0
	...
	out_3_v16i_0r_g_b_vectors[2] = _mm_shuffle_epi8(in_2_v8i_argb_vectors[1], _M(shuf_b2));	// PSHUFB	1 1 3 0 1 2
	// 0 0		0 0		0 0		0 0		B5 0	B6 0	B7 0	B8 0
	
	out_3_v16i_0r_g_b_vectors[2] = _mm_or_si128(out_3_v16i_0r_g_b_vectors[2], _M(scratch1));	// POR	2   2
	// B1  0	B2 0	B3  0	B4  0	B5  0	B6  0	B7  0	B8  0
};
