...
EXTERN_INLINE void convert_n_nnb_downsample_r_g_b_vectors_to_y_uv_vectors_sse2(__m128i* in_3_v16i_r_g_b_vectors, __m128i* out_2_v16i_y_uv_vectors)
{
	...
	_M(rOdd) = _mm_shufflelo_epi16(_M(rOdd), 0xA0);									// PSHUFLW		2	2
	// 0 R1 0 R1	0 R3 0 R3	0 R5 0 R5	0 R7 0 R7
 ...
 * U12 0	V12 0	U34 0	V34 0	U56 0	V56 0	U78 0	V78 0
 */
EXTERN_INLINE void convert_n_nnb_downsample_r_gb_vectors_to_y_uv_vectors_sse2_ssse3(__m128i* in_3_v16i_r_gb_vectors, __m128i* out_2_v16i_y_uv_vectors)
{
	CONST_M128I(shuf_gbOdd1, 0xFF0AFF08FF02FF00LL, 0xFFFFFFFFFFFFFFFFLL);
	CONST_M128I(shuf_gbOdd2, 0xFFFFFFFFFFFFFFFFLL, 0xFF0AFF08FF02FF00LL);
	CONST_M128I(shuf_rOdd, 0xFF04FF04FF00FF00LL, 0xFF0CFF0CFF08FF08LL);
	CONST_M128I(shuf_gbUCoeffs, 0xFFFF0605FFFF0201LL, 0xFFFF0E0DFFFF0A09LL);
	CONST_M128I(shuf_gbVCoeffs, 0x0605FFFF0201FFFFLL, 0x0E0DFFFF0A09FFFFLL);
	...
	_M(gbOdd) = _mm_shuffle_epi8(in_3_v16i_r_gb_vectors[1], _M(shuf_gbOdd1));		// PSHUB		1 1 3 0 1 2
	// G1 B1	G3 B3	0 0		0 0
	_M(gb1Scratch) = _mm_shuffle_epi8(in_3_v16i_r_gb_vectors[2], _M(shuf_gbOdd2));	// PSHUB		1 1 3 0 1 2
	// 	0 0		0 0		G5 B5	G7 B7
	_M(gbOdd) = _mm_or_si128(_M(gbOdd), _M(gb1Scratch));							// POR			2   2
	// G1 B1	G3 B3	G5 B5	G7 B7

	_M(rOdd) = _mm_shuffle_epi8(in_3_v16i_r_gb_vectors[0], _M(shuf_rOdd));			// PSHUB		1 1 3 0 1 2
	// R1 0 R1 0	R3 0 R3 0	R5 0 R5 0	R7 0 R7 0
	...
	// shift right by 8 to account for left shift by 8 of coefficients
	// and zero hi word
	_M(gb1Scratch) = _mm_shuffle_epi8(_M(gb1Scratch), _M(shuf_gbUCoeffs));			// PSHUB		1 1 3 0 1 2
	// C1 Sb 0 0		C3 Sb 0 0		C5 Sb 0 0		C7 Sb 0 0
	...
	// shift right by 8 to account for left shift by 8 of coefficients,
	// and zero low word. Here we shift left since we need to place the
	// coeffs in the right spot.
	_M(gb2Scratch) = _mm_shuffle_epi8(_M(gb2Scratch), _M(shuf_gbVCoeffs));			// PSHUB		1 1 3 0 1 2
	// 0 0 C1 Sb	0 0 C3 Sb		0 0 C5 Sb		0 0 C7 Sb
