...
// PIXFC FLAGS
#define PIXFC_FLAGS	PIXFC_BT601_CONVERSION_FLAG// | PIXFC_REQUIRE_INTERPOLATION_FLAG
//#define PIXFC_FLAGS	PIXFC_SSE2_ONLY_FLAG
//#define PIXFC_FLAGS	PIXFC_NO_SSE_FLAG
//#define PIXFC_FLAGS	PIXFC_DEFAULT_FLAGS
