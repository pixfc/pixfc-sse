...
#define CONVERT_TO_RGB32(pack_fn, instr_set)\
	CONVERT_YUV_TO_RGB(unpack_yuyv_to_y_uv_vectors_, nnb_upsample_n_convert_y_uv_vectors_to_rgb_vectors_bt709_, 4, pack_fn, instr_set)

#define CONVERT_TO_RGB24(pack_fn, instr_set)\
	CONVERT_YUV_TO_RGB(unpack_yuyv_to_y_uv_vectors_, nnb_upsample_n_convert_y_uv_vectors_to_rgb_vectors_bt709_, 3, pack_fn, instr_set)
...
void		upsample_n_convert_yuyv_to_rgb24_bt709_sse2_slowrepacking(const struct PixFcSSE * pixfc, void* source_buffer, void* dest_buffer) {
...
void		upsample_n_convert_yuyv_to_bgr24_bt709_sse2_slowrepacking(const struct PixFcSSE * pixfc, void* source_buffer, void* dest_buffer) {
