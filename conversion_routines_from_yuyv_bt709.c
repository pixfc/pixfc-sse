...
#define CONVERT_TO_RGB32(pack_fn, instr_set)\
	CONVERT_YUV_TO_RGB(unpack_yuyv_to_y_uv_vectors_, convert_y_uv_vectors_to_rgb_vectors_bt709_, 4, pack_fn, instr_set)

#define CONVERT_TO_RGB24(pack_fn, instr_set)\
	CONVERT_YUV_TO_RGB(unpack_yuyv_to_y_uv_vectors_, convert_y_uv_vectors_to_rgb_vectors_bt709_, 3, pack_fn, instr_set)


#define CONVERT_TO_RGB32_NO_INTERPOLATION(pack_fn, instr_set)\
	CONVERT_YUV_TO_RGB_NO_INTERPOLATION(unpack_yuyv_to_y_uv_vectors_, convert_y_uv_vectors_to_rgb_vectors_bt709_no_interpolation_, 4, pack_fn, instr_set)

#define CONVERT_TO_RGB24_NO_INTERPOLATION(pack_fn, instr_set)\
	CONVERT_YUV_TO_RGB_NO_INTERPOLATION(unpack_yuyv_to_y_uv_vectors_, convert_y_uv_vectors_to_rgb_vectors_bt709_no_interpolation_, 3, pack_fn, instr_set)
