...
#define CONVERT_TO_RGB32(pack_fn, instr_set)\
	CONVERT_YUV_TO_RGB(unpack_uyvy_to_y_uv_vectors_, convert_y_uv_vectors_to_rgb_vectors_no_interpolation_, 4, pack_fn, instr_set)

#define CONVERT_TO_RGB24(pack_fn, instr_set)\
	CONVERT_YUV_TO_RGB(unpack_uyvy_to_y_uv_vectors_, convert_y_uv_vectors_to_rgb_vectors_no_interpolation_, 3, pack_fn, instr_set)
