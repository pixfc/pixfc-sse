...
EXTERN_INLINE void pack_6_rgb_vectors_in_4_bgra_vectors_sse2(__m128i* in_6_r_g_b_vectors, __m128i* out_4_bgra_vectors) {
	...
	out_4_bgra_vectors[0] = _mm_unpacklo_epi16(bg, ra);					// PUNPCKLWD	1	0.5
	// B1 G1	R1 A1	B2 G2	R2 A2	B3 G3	R3 A3	B4 G4	R4 A4

	out_4_bgra_vectors[1] = _mm_unpackhi_epi16(bg, ra);					// PUNPCKHWD	1	0.5
	// B5 G5	R5 A5	B6 G6	R6 A6	B7 G7	R7 A7	B8 G8	R8 A8
	...
	out_4_bgra_vectors[2] = _mm_unpacklo_epi16(bg, ra);					// PUNPCKLWD	1	0.5
	// B9 G9	R9 A9	B10 G10	R10 A10	B11 G11	R11 A11	B12 G12	R12 A12

	out_4_bgra_vectors[3] = _mm_unpackhi_epi16(bg, ra);					// PUNPCKHWD	1	0.5
	// B13 G13	R13 A13	B14 G14	R14 A14	B15 G15	R15 A15	B16 G16	R16 A16
};
...
EXTERN_INLINE void pack_6_rgb_vectors_in_4_argb_vectors_sse2(__m128i* in_6_r_g_b_vectors, __m128i* out_4_argb_vectors) {
	...
	out_4_argb_vectors[0] = _mm_unpacklo_epi16(ar, gb);					// PUNPCKLWD	1	0.5
	// A1 R1	G1 B1	A2 R2	G2 B2	A3 R3	G3 B3	A4 R4	G4 B4

	out_4_argb_vectors[1] = _mm_unpackhi_epi16(ar, gb);					// PUNPCKHWD	1	0.5
	// A5 R5	G5 B5	A6 R6	G6 B6	A7 R7	G7 B7	A8 R8	G8 B8
	...
	out_4_argb_vectors[2] = _mm_unpacklo_epi16(ar, gb);					// PUNPCKLWD	1	0.5
	// A9 R9	G9 B9	A10 R10	G10 B10	A11 R11	G11 B11	A12 R12 G12 B12

	out_4_argb_vectors[3] = _mm_unpackhi_epi16(ar, gb);					// PUNPCKHWD	1	0.5
	// A13 R13	G13 B13	A14 R14 G14 B14	A15 R15	G15 B15	A16 R16	G16 B16
};
